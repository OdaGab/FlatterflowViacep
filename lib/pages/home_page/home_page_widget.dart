  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.network(
                                  'https://www.impacta.edu.br/themes/wc_agenciar3/images/footer/impacta_footer.png',
        ...
        appBar: AppBar(
          backgroundColor: Color(0xFFCAC9D4),
          ...
          flexibleSpace: FlexibleSpaceBar(
            ...
            titlePadding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 25.0),
          ),
          elevation: 2.0,
        ),
        body: SafeArea(
                          ...
                          () async {
                            safeSetState(() {
                              _model.textFieldCepTextController?.text =
                                  _model.textFieldCepTextController.text;
                              _model.textFieldCepFocusNode?.requestFocus();
                              WidgetsBinding.instance.addPostFrameCallback((_) {
                                _model.textFieldCepTextController?.selection =
                                    TextSelection.collapsed(
                                  offset: _model
                                      .textFieldCepTextController!.text.length,
                                );
                              });
                            });
                            _model.apiResultlxx = await ConCepCall.call(
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        cursorColor: FlutterFlowTheme.of(context).primaryText,
                        enableInteractiveSelection: true,
                        validator: _model.textFieldBairroTextControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ),
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        cursorColor: FlutterFlowTheme.of(context).primaryText,
                        enableInteractiveSelection: true,
                        validator: _model.textFieldCidadeTextControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ),
